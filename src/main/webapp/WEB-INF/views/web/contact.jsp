        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form modelAttribute="customerDTO" action="" method="post" id="customerInfo">
                        <div class="row">
                            <div class="col">
                                <form:input path="name" class="form-control" placeholder="Họ và tên"/>
                            </div>
                            <div class="col">
                                <form:input path="email" class="form-control" placeholder="Email"/>
                            </div>
                        </div>
                        <form:input path="customerPhone" class="form-control mt-3" placeholder="Số điện thoại"/>
                        <form:input path="demand" class="form-control mt-3" placeholder="Nội dung"/>
                        <button class="btn btn-primary px-4 mt-3" id="btn-submit" type="button">
                            Gửi liên hệ
                        </button>
                    </form:form>
                </div>
        ...
        function saveCustomer(customerInfoJson) {
            $.ajax({
                ...
                error: function (response) {
                    var err = response.responseJSON.data;
                    alert(err)
                }
            });
        };
