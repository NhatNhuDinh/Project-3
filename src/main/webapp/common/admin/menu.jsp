...
<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
    ...
    <ul class="nav nav-list">
        <li class="">
            <a href="#" class="dropdown-toggle">
                <i class="ace-icon glyphicon glyphicon-home" style="margin-right: 8px;"></i>
                <span class="menu-text">Quản lí tòa nhà</span>
            </a>
            <b class="arrow"></b>
            <ul class="submenu">
                <li class="">
        ...
        <security:authorize access="hasAnyRole('MANAGER')">
            <li class="">
                <a href="#" class="dropdown-toggle">
                    <i class="ace-icon glyphicon glyphicon-user" style="margin-right: 8px;"></i>
